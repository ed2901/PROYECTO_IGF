    ...
    <div class="flex justify-center">
        <div class="w-full">
            ...
            @if(Auth::user()->rol === 'admin')
                ...
                <div class="p-4">
                <h5>Bienvenido {{ Auth::user()->name }}, estás conectado al sistema de triage hospitalario.</h5>
                Usuario: <span class="bg-purple-100 text-purple-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300">Recepcion</span>
                    ...
                    <div class="flex flex-wrap mt-4">
                        ...
                        <div class="w-full md:w-1/3 p-2">
                            <div class="bg-white border-4 border-green-500 p-4 rounded-lg shadow-md">
                                ...
                                <p class="text-gray-600">Ver y editar informacion de los pacientes registrados</p>
                        ...
                        <div class="w-full md:w-1/3 p-2">
                            <div class="bg-white border-4 border-red-500 p-4 rounded-lg shadow-md">
                                ...
                                <p class="text-gray-600">Evalua el nivel de urgencia de cada paciente</p>
                        ...
                        <div class="w-full md:w-1/3 p-2">
                            <div class="bg-white border-4 border-blue-500 p-4 rounded-lg shadow-md">
                                ...
                                <a href="{{ url('/codigos-triage') }}" class="inline-block mt-2 px-4 py-2 bg-blue-500 text-white rounded hover:bg-green-600">
                                    Entrar
                                </a>
                            </div>
                        </div>
